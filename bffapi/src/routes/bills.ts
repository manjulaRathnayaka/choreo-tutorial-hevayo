...
import { accountsService } from '../utils/serviceClient';
import { validate, billSchema, idParamSchema } from '../middleware/validation';
 ...
 *         description: Server error
 */
router.post('/', validate(billSchema, 'body'), async (req: Request, res: Response, next: NextFunction) => {
  try {
