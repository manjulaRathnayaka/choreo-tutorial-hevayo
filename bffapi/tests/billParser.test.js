...
const { billParserService, accountsService } = require('../src/utils/serviceClient');
...
describe('Bill Parser API', () => {
  ...
  describe('POST /api/parser/parse-bill', () => {
    it('should parse a bill image', async () => {
      ...
      billParserService.parseBillImage.mockResolvedValue(mockParsedData);
  ...
  describe('POST /api/parser/create-bill-from-image', () => {
    it('should create a bill from parsed image', async () => {
      ...
      billParserService.parseBillImage.mockResolvedValue(mockParsedData);
      accountsService.createBill.mockResolvedValue({ id: 3 });
      ...
      const billData = accountsService.createBill.mock.calls[0][0];
    ...
    it('should use default title if not provided', async () => {
      ...
      billParserService.parseBillImage.mockResolvedValue(mockParsedData);
      accountsService.createBill.mockResolvedValue({ id: 4 });
