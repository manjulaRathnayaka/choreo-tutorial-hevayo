...
import { accountsService } from '../src/utils/serviceClient';
...
describe('Bills API', () => {
  ...
  describe('GET /api/bills', () => {
    it('should return all bills', async () => {
      ...
      (accountsService.getAllBills as jest.Mock).mockResolvedValue(mockBills);
    ...
    it('should handle errors', async () => {
      (accountsService.getAllBills as jest.Mock).mockRejectedValue({
        statusCode: 500,
  ...
  describe('GET /api/bills/:id', () => {
    it('should return a bill by ID', async () => {
      ...
      (accountsService.getBillById as jest.Mock).mockResolvedValue(mockBill);
    ...
    it('should return 404 if bill not found', async () => {
      (accountsService.getBillById as jest.Mock).mockRejectedValue({
        statusCode: 404,
  ...
  describe('POST /api/bills', () => {
    it('should create a new bill', async () => {
      ...
      (accountsService.createBill as jest.Mock).mockResolvedValue(createdBill);
